...
<body bgcolor="skyblue">
	<form action="" method= "post" enctype="multipart/form-data">
		...
		<table align="center" width = "795" border="2" bgcolor="#187ee5">
			<tr align = "center"> 
				<td colspan="7"><h2>Update & Edit Product </h2></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<img src="product_images/<?php echo $pro_image; ?>" width="50" height="50"/></td> 
			</tr>
			<tr>
			...
			<tr>
				...
				<td> <textarea name = "product_desc" cols="20" rows = "10"><?php echo $pro_desc; ?></textarea>

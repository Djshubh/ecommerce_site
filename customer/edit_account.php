...
<form action="" method = "post" enctype="multipart/form-data">
	...
	<table align="center" width="750">
		<tr align="center">
			<td colspan="10"><h2>Update Your Account</h2></td>
		</tr>
		...
		<tr>
			...
			<td><input type="file" name="c_image"/ value="<?php echo $image; ?>" /><img src="customer_images/<?php echo $image; ?>" 
...
<?php
	...
	//	$c_country = $_POST['c_country'];
		...
		$row_update = mysqli_num_rows($run_update);
